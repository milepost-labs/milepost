...
export const networks = {
  testnet: {
    ...
    contractId: "CC3PQUJKHPRSIHIH53GNIC6DIDOIJWCCGQ7NYZROBAS6TZLUGLOM5XQC",
  }
} as const
...
export interface Client {
   ...
   */
  register_schema: ({authority, definition, revocable, restricted, predecessor}: {authority: string, definition: string, revocable: boolean, restricted: boolean, predecessor: Option<Buffer>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Buffer>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "",
        ...
        "",
        ...
        "" ]),
      options
    )
  }
